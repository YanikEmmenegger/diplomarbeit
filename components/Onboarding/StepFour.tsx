        ...
        <div className="">
            <div className="flex flex-col">
                ...
                <button
                    ...
                    className={twMerge("flex-1 mx-1 h-auto rounded-lg p-4 ease-in-out duration-500 opacity-75 transition outline-none mb-4 border-2 bg-transparent border-CalorieCompass-Primary", goal === 2 ? 'bg-CalorieCompass-Primary' : 'bg-transparent')}>
                    Gewicht halten
                </button>
                <button
                    onClick={() => handleButtonClick(3)}
                    className={twMerge("flex-1 mx-1 h-auto rounded-lg p-4 opacity-75 ease-in-out duration-500 transition outline-none mb-4 border-2 bg-transparent border-CalorieCompass-Primary", goal === 3 ? 'bg-CalorieCompass-Primary' : 'bg-transparent')}>
                    Gewicht aufbauen
                </button>
            </div>
        </div>
